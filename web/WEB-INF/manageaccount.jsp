            ...
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4"><div class="chartjs-size-monitor" style="position: absolute; inset: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>
                    <div class="d-flex justify-content-between  align-items-center pb-2 mb-3 border-bottom">
                        <h1 class="h2 mt-3">Manage Account</h1>
                    </div>
                    <form method="POST" action="manageaccount">
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input required name="email" type="email"  class="form-control w-25 w-50-sm" id="newEmail" value="<c:out value="${user.email}"></c:out>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="currentPassword" class="col-sm-2 col-form-label">Enter Current password</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group row">
                                <label for="retypeNewPassword" class="col-sm-2 col-form-label">Retype New password</label>
                                <div class="col-sm-10">
                                    <input required name="retypeNewPassword" type="password" class="form-control w-25" id="retypeNewPassword" placeholder="Retype New Password">
                                </div>
                            </div>
                    ...
                    <a class="btn btn-danger mt-5" href="manageaccount?action=deactivate">Deactivate Account</a>
                </main>
            </div>
        </div>
    </div>
